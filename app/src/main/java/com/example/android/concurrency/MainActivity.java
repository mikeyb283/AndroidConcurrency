...
public class MainActivity extends AppCompatActivity {
    ...
    //TODO: field to represent MyService
    private MyService mService;

    private final ServiceConnection mServiceConn = new ServiceConnection() {
        @Override
        public void onServiceConnected(ComponentName name, IBinder service) {
            //TODO: when binding to the service the service will be connected and the onServiceConnected method will be called
        ...
        public void onServiceDisconnected(ComponentName name) {
            if (mService != null) {
                //TODO: release service to allow cleanup with garbage collection
                mService = null;
            }
